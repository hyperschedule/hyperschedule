...
function setMotd() {
	...
	motd.appendChild(
		Redom.el("div", [
			...
			Redom.el('p', ["This means you ", Redom.el('em', 'can still use'), ' Hyperschedule to plan your courses for the upcoming semester (Spring 2021), but beware that our data may not be fully up to date! For the latest and most accurate information, please refer to Portal.'
			])
		])
	);
}
