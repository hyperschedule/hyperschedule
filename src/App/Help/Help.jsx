...
const Help = ({visible, close}) => (
  <Popup title="Help" visible={visible} close={close}>
    <div id="help">
      <p>
        The <strong>Course Search</strong> tab lists all courses for
        the coming semester. Click on the{" "}
      ...
      <p>
        ...
        ), star them (<i className="ion-md-star-outline" />
        ), and disable them (<i className="ion-md-square-outline" />
        ).
      </p>
      <p>
        The <strong>Schedule</strong> tab is, of course, the main
        event. Scheduling is simple: first, all of your starred
        courses are scheduled, regardless of conflicts. Then, as many
        remaining courses as possible are scheduled as long as they
        don&rsquo;t conflict: the algorithm starts from the top of
        your list and goes down. Courses that are disabled, however,
        won&rsquo;t be considered. So, to change your schedule, just
        use reordering, starring, and disabling, rather than paging
